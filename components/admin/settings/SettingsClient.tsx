    ...
    <div className="space-y-8">
      <Section title="Social URLs">
        <Field
          ...
          placeholder="https://www.instagram.com/homewithsamina/"
        />
        <Field
          label="Facebook"
          ...
          placeholder="https://www.facebook.com/SaminaBilalRealtor/"
        />
        <Field
          label="TikTok"
          ...
          placeholder="https://www.tiktok.com/@samina.realtor"
        />
        <Field
    ...
    <div className="space-y-8">
      <Section title="Bottom bar">
        <Field
          ...
          help='Example: "© 2026 Samina Bilal · Licensed in VA & MD". Empty falls back to an auto-built line.'
        />
        <Field
          label="Design credit"
