...
/**
 * One-time admin signup. After the first user is created, this page should
 * be removed or guarded — additional users get invited from the Team
...
export default function SignupPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      setSuccess(true);
      setLoading(false);
      // After Supabase confirms email (or instantly if confirmation disabled),
      // user will land on /admin/login.
