...
const ALL: Block[] = [
  ...
  { page_key: "home", block_type: "dark_break", position: 80, enabled: true, data: { eyebrow: "Why I Do This Work", quote: "Real estate is the most important purchase most people make. It deserves a Real Estate Specialist who treats it that way.", attribution: "Samina", wrapper: {} } },
  ...
  // ───────────────────────────────────────────────────────────── INVEST
  { page_key: "path-to-ownership", block_type: "hero", position: 10, enabled: true, data: { eyebrow: p.hero.eyebrow, titleLines: p.hero.titleLines, subtitle: p.hero.subtitle, ctas: [], stats: [], wrapper: {} } },
  { page_key: "path-to-ownership", block_type: "paragraph_block", position: 20, enabled: true, data: { eyebrow: p.truth.eyebrow, heading: p.truth.heading, paragraphs: [p.truth.body], wrapper: { spacing: "large" } } },
  { page_key: "path-to-ownership", block_type: "process_steps", position: 30, enabled: true, data: { eyebrow: "The Process", heading: "Four Steps to a Smart Acquisition", steps: p.steps.map((st) => ({ n: st.n, h: st.title, p: st.body })), wrapper: { theme: "cream", spacing: "large" } } },
  { page_key: "path-to-ownership", block_type: "stats_strip", position: 40, enabled: true, data: { stats: p.stats.map((s) => ({ value: String(s.to), prefix: (s as { prefix?: string }).prefix, suffix: (s as { suffix?: string }).suffix, label: s.label })), wrapper: { spacing: "large" } } },
  { page_key: "path-to-ownership", block_type: "bullet_list", position: 50, enabled: true, data: { eyebrow: p.forWho.eyebrow, heading: p.forWho.heading, bullets: p.forWho.lines, wrapper: { theme: "cream", spacing: "large" } } },
  { page_key: "path-to-ownership", block_type: "dark_break", position: 60, enabled: true, data: { eyebrow: "The Strategy", quote: "Real properties. Real numbers. Real returns.", attribution: "", wrapper: {} } },
  { page_key: "path-to-ownership", block_type: "faq", position: 70, enabled: true, data: { eyebrow: "Common Questions", heading: "Answered", items: p.faqs, wrapper: { spacing: "large" } } },
  { page_key: "path-to-ownership", block_type: "cta_band", position: 80, enabled: true, data: { eyebrow: "", heading: p.cta.heading, body: p.cta.body, primary: p.cta.primary, wrapper: {} } },
