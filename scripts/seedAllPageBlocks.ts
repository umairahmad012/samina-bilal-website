...
const ALL: Block[] = [
  ...
  { page_key: "path-to-ownership", block_type: "stats_strip", position: 40, enabled: true, data: { stats: p.stats.map((s) => ({ value: String(s.to), prefix: s.prefix, suffix: s.suffix, label: s.label })), wrapper: { spacing: "large" } } },
